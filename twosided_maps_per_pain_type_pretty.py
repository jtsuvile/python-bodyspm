...
outfilename = '/m/nbe/scratch/socbrain/kipupotilaat/figures/compare_pain_locations_by_pain_type_pains.png'
...
fig, axs = plt.subplots(len(stim_names),len(pain_names), figsize=(11, 7), facecolor='w', edgecolor='k')
...
[[x10,y10],[x11,y11]] = axs[7].get_position().get_points()
...
plt.gcf().text(0.03, 0.80, "Current pain", fontsize=20, rotation=90)
plt.gcf().text(0.03, 0.38, "Chronic pain", fontsize=20, rotation=90)
#plt.show()
