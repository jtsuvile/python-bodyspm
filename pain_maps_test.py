...
dataloc = '/Volumes/Shield2/kipupotilaat/data/endometriosis/processed'
datafile = get_latest_datafile(dataloc)

dataloc_controls = '/Volumes/Shield2/kipupotilaat/data/endometriosis/matched_controls'
...
plt.savefig(figloc+'pain_location_controls_pain_testing_fdr.png')
plt.close()