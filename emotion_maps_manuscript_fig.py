...
outfilename = '/Users/juusu53/Documents/projects/kipupotilaat/stockholm/figures/emotions_lbp_fibro.png'
...
plt.gcf().text(0.11, 0.57, "Fibromyalgia patients", fontsize=24, rotation=90)
plt.gcf().text(0.11, 0.3, "LBP patients", fontsize=24, rotation=90)
