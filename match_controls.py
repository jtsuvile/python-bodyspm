...
dataloc_pain = '/Volumes/Shield1/kipupotilaat/data/endometriosis/processed/'
pain_bg = pd.DataFrame(columns=['subid','age','sex','pain_now'])
csvname = '/Volumes/Shield1/kipupotilaat/data/endometriosis/endometriosis_matched_controls_2024_03_22.csv'


dataloc_controls = '/Volumes/Shield1/kipupotilaat/data/controls/processed/'
